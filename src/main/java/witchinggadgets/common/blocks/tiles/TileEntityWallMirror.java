...
public class TileEntityWallMirror extends TileEntityWGBase {
    ...
    // playerMP.timeUntilPortal = 10;
    // playerMP.mcServer.getConfigurationManager().transferPlayerToDimension(playerMP, WGConfig.dimensionMirrorID, new
    // TeleporterMirror(mServer.worldServerForDimension(WGConfig.dimensionMirrorID)));
